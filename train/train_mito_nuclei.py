...
from dataset import M_N_dataset
...
trainDS = M_N_dataset(image_dir=train_img_path, label_dir=train_nucleus_path, transform=train_transform)
valDS =  M_N_dataset(image_dir=val_img_path, label_dir=val_nucleus_path, transform=test_transform)
